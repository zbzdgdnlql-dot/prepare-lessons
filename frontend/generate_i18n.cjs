...
const keys = {
    ...
    "lang_zh": {"zh": "中文", "fr": "chinois", "es": "chino", "de": "Chinesisch"},
    ...
    "unknown_module": {"zh": "未知模块", "fr": "Module inconnu", "es": "Módulo desconocido", "de": "Unbekanntes Modul"},
    "alert_bookmark": {"zh": "已收藏：", "fr": "Ajouté aux favoris : ", "es": "Añadido a favoritos : ", "de": "Zu Lesezeichen hinzugefügt : "},
    "alert_input": {"zh": "请输入或上传文本内容", "fr": "Veuillez saisir ou télécharger un texte", "es": "Por favor ingrese o suba un texto", "de": "Bitte geben Sie Text ein oder laden Sie ihn hoch"},
    "alert_select_module": {"zh": "请至少选择一个生成模块", "fr": "Veuillez sélectionner au moins un module", "es": "Por favor seleccione al menos un módulo", "de": "Bitte wählen Sie mindestens ein Modul aus"},
    "alert_parse_fail": {"zh": "解析失败: ", "fr": "Échec de l'analyse : ", "es": "Error de análisis : ", "de": "Analyse fehlgeschlagen : "},
    "alert_network_err": {"zh": "网络错误，请确保后端服务已启动", "fr": "Erreur réseau, assurez-vous que le serveur est démarré", "es": "Error de red, asegúrese de que el servidor esté iniciado", "de": "Netzwerkfehler, stellen Sie sicher, dass der Server gestartet ist"},
    "alert_extract_fail": {"zh": "提取失败: ", "fr": "Échec de l'extraction : ", "es": "Error de extracción : ", "de": "Extraktion fehlgeschlagen : "},
    "alert_gen_fail": {"zh": "生成失败: ", "fr": "Échec de la génération : ", "es": "Error de generación : ", "de": "Generierung fehlgeschlagen : "},
    "alert_export_fail": {"zh": "导出失败", "fr": "Échec de l'exportation", "es": "Error de exportación", "de": "Export fehlgeschlagen"},
};

const langs = ['zh', 'fr', 'es', 'de'];
...
langs.forEach(lang => {
    ...
    fs.writeFileSync(path.join(dir, 'translation.json'), JSON.stringify(out, null, 2), 'utf-8');
});

console.log("i18n files generated!");
